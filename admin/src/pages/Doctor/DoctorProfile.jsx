  ...
  return profileData && (
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        <div>
          <img className='bg-primary/50 w-full sm:max-w-64 rounded-lg' src={profileData.image} alt="" />
        </div>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex gap-2 py-2'>
            <p>Address:</p>
            <p className='text-sm'>
              {isEdit ? <input type="text" onChange={(e) => setProfileData(prev => ({...prev, address: {...prex.address, line1:e.target.value}}))} value={profileData.address.line1} /> : profileData.address.line1}
              <br />
              {isEdit ? <input type="text" onChange={(e) => setProfileData(prev => ({...prev, address: {...prex.address, line2:e.target.value}}))} value={profileData.address.line2} /> : profileData.address.line2}
            </p>
          </div>
